              ...
              <div class="field">
                <div class="control">
                  ...
                  <div class="form-error" v-if="$v.form.username.$error">
                    ...
                    <span class="help is-danger" v-if="!$v.form.username.minLength">Username minimum length is 6 character</span>
                  </div>
                </div>
              </div>
              <div class="field">
                <div class="control">
                  ...
                  <div class="form-error" v-if="$v.form.name.$error">
                    ...
                    <span class="help is-danger" v-if="!$v.form.name.minLength">Name minimum length is 6 character</span>
                  </div>
                </div>
              </div>
              <div class="field">
                ...
                <div class="control">
                  <input
                   ...
                   <div class="form-error" v-if="$v.form.avatar.$error">
                    ...
                    <span class="help is-danger" v-if="!$v.form.avatar.supportedFileType">Selected file type is not valid!</span>
                  </div>
                </div>
              </div>
              <div class="field">
              ...
              <div class="field">
                <div class="control">
                  ...
                  <div class="form-error" v-if="$v.form.passwordConfirmation.$error">
                    ...
                    <span class="help is-danger" v-if="!$v.form.passwordConfirmation.sameAs">Password confirmation should be the same as password</span>
                  </div>
                </div>
              </div>
              <button @click.prevent="register" type="button" class="button is-block is-info is-large is-fullwidth" :disabled="$v.form.$invalid">Register</button>
            </form>
          </div>
